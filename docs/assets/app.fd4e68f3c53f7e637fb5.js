...
/******/ 		return __webpack_require__.p + "" + ({"styles":"styles"}[chunkId]||chunkId) + "." + "fd4e68f3c53f7e637fb5" + ".js"
/******/ 	}
/******/
...
function (_Component) {
  ...
  function BackToTop() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlesOnBackButtonClick", function (event) {
      if (event) {
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollDone", function () {
...
function (_PureComponent) {
  ...
  function NavigationBar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlesNavItemClick", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlesDisconnect", function (evt) {
      if (evt) {
        evt.preventDefault();
      }
...
function (_Component) {
  ...
  _createClass(PrivateRoute, [{
    ...
    value: function isAuthenticated() {
      ...
      var isAuthenticated = checkUserHasId;
      console.log(isAuthenticated.toString());
  ...
  return function (BaseComponent) {
    ...
    function (_Component) {
      ...
      function WithMainLayout() {
        ...
        _defineProperty(_assertThisInitialized(_this), "handleLeftNavItemClick", function (event, viewName) {// something to do here?
        });

        _defineProperty(_assertThisInitialized(_this), "handleRightNavItemClick", function (event, viewName) {// something to do here?
        });
...
//    headers: {}     // OPTIONAL CONTENT like: updateDropdown: { someprop: 'value ...}
...
/* harmony import */ var _services_API_FetchServerData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/API/FetchServerData */ "./src/front/services/API/FetchServerData.js");
...
function fakeFetch() {
  return function (dispatch) {
    ...
    var url = "".concat(Object(_services_API_FetchServerData__WEBPACK_IMPORTED_MODULE_3__["getLocationOrigin"])(), "/").concat(_config_appConfig__WEBPACK_IMPORTED_MODULE_2__["default"].api.fakeEndPoint);
    var method = 'get';
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                mockResult = _mock_userInfosMock_json__WEBPACK_IMPORTED_MODULE_2__; // will be fetch_mock updateDropdown returned (in case FETCH_TYPE = 'FETCH_MOCK', otherwise cata come from server)

                url = "".concat(Object(_services_API_FetchServerData__WEBPACK_IMPORTED_MODULE_3__["getLocationOrigin"])(), "/").concat(__SOME_LOGIN_API__);
                method = 'post';
                headers = {};
                options = {
...
function fetchUserInfosData() {
  ...
  return function (dispatch) {
    ...
    var mockResult = _mock_userInfosMock_json__WEBPACK_IMPORTED_MODULE_2__; // will be fetch_mock updateDropdown returned (in case FETCH_TYPE = 'FETCH_MOCK', otherwise cata come from server)

    var url = "".concat(Object(_services_API_FetchServerData__WEBPACK_IMPORTED_MODULE_3__["getLocationOrigin"])(), "/").concat(users, "/").concat(id);
    var method = 'get';
    var headers = {
...
/* harmony import */ var _modules_reducers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modules/reducers */ "./src/front/redux/modules/reducers.js");
/* harmony import */ var _middleware_fetchMiddleware__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../middleware/fetchMiddleware */ "./src/front/redux/middleware/fetchMiddleware.js");
// #region imports
...
var createHistory = __webpack_require__(/*! history */ "./node_modules/history/esm/history.js").createBrowserHistory; // #endregion
...
var history = createHistory(); // #endregion
...
var enhancer = Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_3__["composeWithDevTools"])(Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_4__["default"], Object(connected_react_router__WEBPACK_IMPORTED_MODULE_2__["routerMiddleware"])(history), _middleware_fetchMiddleware__WEBPACK_IMPORTED_MODULE_6__["default"], loggerMiddleware // logger at the end
)); // #endregion

function configureStore(initialState) {
  var store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(Object(connected_react_router__WEBPACK_IMPORTED_MODULE_2__["connectRouter"])(history)(_modules_reducers__WEBPACK_IMPORTED_MODULE_5__["default"]), initialState, enhancer);
...
var MainRoutes = function MainRoutes() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router__WEBPACK_IMPORTED_MODULE_1__["Switch"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router__WEBPACK_IMPORTED_MODULE_1__["Route"], {
    ...
    path: "/account",
    component: _routes__WEBPACK_IMPORTED_MODULE_2__["Account"]
...
/*!************************************!*\
  !*** ./src/front/routes/routes.js ***!
  \************************************/
/*! exports provided: Home, About, Account, Login, Protected, PageNotFound, PrivateRoute */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Home = Object(loadable_components__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
  return Promise.all(/*! import() */[__webpack_require__.e("vendors"), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, /*! ../pages/home */ "./src/front/pages/home/index.js"));
}, {
  modules: ['../pages/home']
});
var About = Object(loadable_components__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
  return Promise.all(/*! import() */[__webpack_require__.e("vendors"), __webpack_require__.e(1), __webpack_require__.e(4)]).then(__webpack_require__.bind(null, /*! ../pages/about */ "./src/front/pages/about/index.js"));
}, {
  modules: ['../pages/about']
});
var Account = Object(loadable_components__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
  return Promise.all(/*! import() */[__webpack_require__.e("vendors"), __webpack_require__.e(0), __webpack_require__.e(6)]).then(__webpack_require__.bind(null, /*! ../pages/account */ "./src/front/pages/account/index.js"));
}, {
  modules: ['../pages/account']
});
var Login = Object(loadable_components__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
  return Promise.all(/*! import() */[__webpack_require__.e("vendors"), __webpack_require__.e(0), __webpack_require__.e(7)]).then(__webpack_require__.bind(null, /*! ../pages/login */ "./src/front/pages/login/index.js"));
}, {
  modules: ['../pages/login']
});
var Protected = Object(loadable_components__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
  return Promise.all(/*! import() */[__webpack_require__.e("vendors"), __webpack_require__.e("styles"), __webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, /*! ../pages/protected */ "./src/front/pages/protected/index.js"));
}, {
  modules: ['../pages/protected']
});
var PageNotFound = Object(loadable_components__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
  return Promise.all(/*! import() */[__webpack_require__.e("vendors"), __webpack_require__.e(5)]).then(__webpack_require__.bind(null, /*! ../pages/pageNotFound */ "./src/front/pages/pageNotFound/index.js"));
}, {
...
/***/ "./src/front/services/API/FetchServerData.js":
/*!***************************************************!*\
  !*** ./src/front/services/API/FetchServerData.js ***!
  \***************************************************/
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _fetchTools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetchTools */ "./src/front/services/API/fetchTools.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
  ...
  regeneratorRuntime.mark(function _callee(scenario, isTest) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getAllScenariosByName/' + scenario + '/' + isTest, {
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
              }
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getAllScenariosByName/' + scenario + '/' + isTest, {
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
              }
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'file/' + filename, {
              headers: {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getUniqueNames', {
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
              }
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getNavItems/' + scenario + '/' + isTest, {
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
              }
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getFieldNames/' + scenario + '/' + isTest, {
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
              }
    ...
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            return _context7.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getFieldNames', {
              headers: {
    ...
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            return _context8.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'get/' + id, {
              headers: {
                'Access-Control-Allow-Origin': '*'
              }
            }).then(function (response) {
    ...
    return regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            return _context9.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getFramework/' + scenario + '/' + isTest, {
              method: 'GET',
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            return _context10.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'autofill/' + pageName, {
              method: 'GET',
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    return regeneratorRuntime.wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            return _context11.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'create', {
              method: 'POST',
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
...
var autoFillPageObjects = function autoFillPageObjects(data) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'autoFillPageObjects', _objectSpread({
      signal: signal
    ...
    return regeneratorRuntime.wrap(function _callee13$(_context13) {
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            return _context13.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'edit/' + id, {
              method: 'PUT',
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    return regeneratorRuntime.wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            return _context14.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'delete/' + data, {
              method: 'DELETE',
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    return regeneratorRuntime.wrap(function _callee15$(_context15) {
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            return _context15.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + 'getAllFrameworkDataByName/' + framework + '', {
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
              }
    ...
    return regeneratorRuntime.wrap(function _callee16$(_context16) {
      while (1) {
        switch (_context16.prev = _context16.next) {
          case 0:
            return _context16.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + frameworktype + '/' + scenario + '/' + isTest, {
              headers: {
                'Accept': 'application/json',
    ...
    return regeneratorRuntime.wrap(function _callee17$(_context17) {
      while (1) {
        switch (_context17.prev = _context17.next) {
          case 0:
            return _context17.abrupt("return", fetch('https://virtualizationtoolbackend.herokuapp.com/' + frameworktype + '/' + scenario + '/' + isTest, {
              headers: {
                'Accept': 'application/json',
                'Content-Type': 'text/plain'
              }
...
var auth = {
   ...
   *    -> answer is:  YES^^
   * BUT
   * -> : your backend will not recognize a wrong token so private updateDropdown or safe and you protected view could be a bit ugly without any updateDropdown.
   *
   * => ON CONCLUSION: this aim of 'isAuthenticated'
   *    -> is to help for a better "user experience"  (= better than displaying a view with no updateDropdown since server did not accept the user).
...
/******/ });
//# sourceMappingURL=app.fd4e68f3c53f7e637fb5.js.map