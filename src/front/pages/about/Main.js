        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="2">
            <Row>
              ...
              {/*  <br/>*/}
              {/*  <Card>*/}
              {/*    <CardHeader color="link" icon="info" tag="h5">Tools*/}
              {/*    </CardHeader>*/}
              {/*    <CardBody style={{backgroundColor: 'Light'}}>*/}
              {/*      <br/>*/}
              ...
              {/*        <InputGroupAddon addonType="prepend">*/}
              {/*          <InputGroupText>*/}
              {/*            <InputGroupButtonDropdown addonType="prepend" isOpen={this.state.dropdownOpenAccessType}*/}
              {/*                                      toggle={this.toggleSplitTools}>*/}


              {/*              <ButtonDropdown isOpen={this.state.dropdownOpenTools} toggle={this.toggleDropdownTools}>*/}
              ...
              {/*                </DropdownMenu>*/}
              {/*              </ButtonDropdown>*/}
              {/*              <Input addon type="input" aria-label="type" value={this.state.toolSelectedPage}/>*/}
              {/*            </InputGroupButtonDropdown>*/}
              {/*          </InputGroupText>*/}
              {/*        </InputGroupAddon>*/}
              {/*      </InputGroup>*/}
              ...
              {/*        <Input addonType="append" placeholder="Example: http://www.google.com" name="generateUrl"*/}
              {/*               onChange={this.handleInputChange} ></Input>{' '}*/}
              {/*      </InputGroup>*/}
              {/*      <br/>*/}
              {/*      <InputGroup style={{width: '100%'}}>*/}
              {/*        <InputGroupAddon addonType="prepend">@ Navigate To</InputGroupAddon>*/}
              {/*        <Input addonType="append" placeholder="Example: css" name="selector1"*/}
              {/*               onChange={this.handleInputChange}></Input>{' '}*/}
              {/*      </InputGroup>*/}
              {/*      <br/>*/}
              {/*      <InputGroup style={{width: '100%'}}>*/}
              {/*        <InputGroupAddon addonType="prepend">@ And</InputGroupAddon>*/}
              {/*        <Input addonType="append" placeholder="Example: css" name="selector2"*/}
              {/*               onChange={this.handleInputChange}></Input>{' '}*/}
              {/*      </InputGroup>*/}
              {/*      <br/>*/}
              {/*      <InputGroup style={{width: '100%'}}>*/}
              {/*        <InputGroupAddon addonType="prepend">@ And</InputGroupAddon>*/}
              {/*        <Input addonType="append" placeholder="Example: css" name="selector3"*/}
              {/*               onChange={this.handleInputChange}></Input>{' '}*/}
              {/*      </InputGroup>*/}
              {/*      <br/>*/}
              {/*      <InputGroup style={{width: '100%'}}>*/}
              ...
              {/*          <InputGroupAddon addonType="prepend">*/}
              {/*            <InputGroupText>*/}
              {/*              <Input addon type="input" aria-label="type" value={this.state.typeNameSelectors}/>*/}
              {/*              <InputGroupButtonDropdown addonType="prepend" isOpen={this.state.splitButtonOpenAccessTypes}*/}
              {/*                                        toggle={this.toggleSplitAccessTypes}>*/}
              {/*                <ButtonDropdown isOpen={this.state.dropdownOpenAccessType} toggle={this.toggledropdownAccessType}>*/}
              {/*                  <DropdownToggle caret>*/}
              {/*                    Choose Type*/}
              {/*                  </DropdownToggle>*/}
              {/*                  <DropdownMenu>*/}
              {/*                    {this.state.webElementTypes.map(e => {*/}
              {/*                      return <DropdownItem key={e.id}*/}
              {/*                                           dataset={e.typeName}*/}
              {/*                                           value={e.typeName}*/}
              {/*                                           onClick={this.handleTypesGenerationProcess}*/}
              {/*                      >{e.typeName}*/}
              {/*                      </DropdownItem>;*/}
              {/*                    })}*/}
              {/*                  </DropdownMenu>*/}
              ...
              {/*                        onClick={this.autoFillPageObjects}>Generate Id's</Button>{' '}*/}
