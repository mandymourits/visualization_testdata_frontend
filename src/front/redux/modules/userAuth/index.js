...
import { getLocationOrigin } from '../../../services/API/FetchServerData';
...
function logUser(login: string, password: string): Promise<any> {
  return async (dispatch: Dispatch<State>): Promise<any> => {
    ...
    const mockResult = userInfosMockData; // will be fetch_mock updateDropdown returned (in case FETCH_TYPE = 'FETCH_MOCK', otherwise cata come from server)
